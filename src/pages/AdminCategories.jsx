...
import { fetchCategories, deleteCategory } from '../http/productApi';
import { Button, Container, Spinner, Table } from 'react-bootstrap';
import CreateCategory from '../components/modals/CreateCategory';

const AdminCategories = () => {
  const [categories, setCategories] = React.useState(''); // список загруженных категорий
  ...
  return (
    <Container>
      ...
      <CreateCategory id={categoryId} show={show} setShow={setShow} setChange={setChange} />
      {categories.length > 0 ? (
